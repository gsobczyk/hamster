...
h2. When suggestion doesn't work

try to run command:

pre. dbus-send --session --type=method_call --print-reply --dest=org.gnome.Hamster /org/gnome/Hamster org.gnome.Hamster.GetExtActivities string:"PIT"

It should return some issues instead of empty array (search query: "PIT").
